...
The final version processes data in bounded chunks:
...
| Section | Purpose |
|---|---|
| `paths` | Dataset discovery, output root, original SimLingo source/checkpoint, FLUX, LaMa, temporary cache |
